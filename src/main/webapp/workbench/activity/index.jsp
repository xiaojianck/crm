            ...
            $("#addBtn").click(function () {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        //取出当前登录用户的id，将id赋予到所有者下拉框的默认值
                        //取出当前登录用户的id
                        //在js中使用el表达式取值，el表达式必须要套用在字符串中
                        var id = "${user.id}";
                        $("#create-owner").val(id);
                        //在下拉框中的值铺完后，打开添加操作的模态窗口
