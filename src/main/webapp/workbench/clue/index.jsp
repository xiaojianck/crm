    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar"
            ...
            <div class="btn-group" style="position: relative; top: 18%;">
                <button type="button" class="btn btn-primary" data-toggle="modal" id="addBtn"><span
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td><a style="text-decoration: none; cursor: pointer;"
                           onclick="window.location.href='workbench/clue/detail.do?id=c1eb9c2a08ec4aa4a6bfce322b567bf2';">王健林</a></td>
                    <td>万达</td>
                    <td>4567895</td>
                    <td>14578963215</td>
                    <td>老朋友</td>
